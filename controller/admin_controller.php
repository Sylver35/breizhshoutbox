	...
	public function acp_shoutbox_robot()
	{
		...
		if ($this->request->is_set_post('update'))
		{
			...
			$this->functions_admin->update_config([
				...
				'shout_update_username'		=> $this->request->variable('shout_update_username', 1),
				'shout_update_username_priv'=> $this->request->variable('shout_update_username_priv', 1),
		...
		else
		{
			...
			$this->template->assign_vars([
				...
				'SHOUT_UPDATE_USERNAME'		=> $this->functions_admin->construct_radio('shout_update_username', 2),
				'SHOUT_UPDATE_USERNAME_PRIV'=> $this->functions_admin->construct_radio('shout_update_username_priv', 2),
