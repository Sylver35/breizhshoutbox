...
// Language for Logs
	...
	'SHOUT_DIV_IMG_EXPLAIN'			=> 'You can add a background image in the div (preferably having some level of transparency).<br />Image to put in “styles/all/theme/images/”<br />Possibility of having a different image (with an identical name) for each style added.<br />Also set the image position.',
