...
// Robot info messages
	...
	'SHOUT_PURGE_6'				=> '%s Purge the shoutbox done…',
	'SHOUT_PURGE_5'				=> '%s Purge the private shoutbox done…',
	'SHOUT_PURGE_4'				=> '%s Purge of Robot infos done…',
	'SHOUT_PURGE_7'				=> '%s Automatic purge of %s messages in the shoutbox done…',
	'SHOUT_PURGE_8'				=> '%s Automatic purge of %s messages in the private shoutbox done…',
	'SHOUT_DELETE_AUTO_9'		=> '%s Automatic load shedding of %s messages in the shoutbox done…',
	'SHOUT_DELETE_AUTO_10'		=> '%s Automatic load shedding of %s messages in the private shoutbox done…',
