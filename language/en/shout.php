...
$lang = array_merge($lang, array(
	...
	'SHOUT_CONFIG_OPEN_TO'	=> '☢ Change the shoutbox preferences',
	...
	'SHOUT_BBCODE_ERROR_SLASH'	=> '❗ Error, the closing bbcode “%2$s” does not contain a closing slash “/”',
...
// Robot info messages
	...
	'SHOUT_POST_ROBOT_16'		=> '%1$s %2$s just create a new topic: %3$s',
	'SHOUT_POST_ROBOT_17'		=> '%1$s %2$s just edit a message: %3$s',
	'SHOUT_POST_ROBOT_18'		=> '%1$s %2$s just edit a topic: %3$s',
	'SHOUT_POST_ROBOT_19'		=> '%1$s %2$s just edit the last post in the topic: %3$s',
	'SHOUT_POST_ROBOT_20'		=> '%1$s %2$s just replying a topic quoting: %3$s',
	'SHOUT_POST_ROBOT_21'		=> '%1$s %2$s just replying to a topic: %3$s',
	'SHOUT_PREZ_ROBOT_60'		=> '%1$s %2$s just create its presentation: %3$s',
	'SHOUT_PREZ_ROBOT_70'		=> '%1$s %2$s just edit a message in a presentation: %3$s',
	'SHOUT_PREZ_ROBOT_71'		=> '%1$s %2$s just edit a message in its presentation: %3$s',
	'SHOUT_PREZ_ROBOT_72'		=> '%1$s %2$s just edit a presentation: %3$s',
	'SHOUT_PREZ_ROBOT_73'		=> '%1$s %2$s just edit its presentation: %3$s',
	'SHOUT_PREZ_ROBOT_74'		=> '%1$s %2$s just edit the last message in a presentation: %3$s',
	'SHOUT_PREZ_ROBOT_75'		=> '%1$s %2$s just edit the last message in its presentation: %3$s',
	'SHOUT_PREZ_ROBOT_76'		=> '%1$s %2$s just replying to a presentation: %3$s',
	'SHOUT_PREZ_ROBOT_77'		=> '%1$s %2$s just replying to its presentation: %3$s',
	'SHOUT_PREZ_ROBOT_80'		=> '%1$s %2$s just replying a presentation quoting: %3$s',
	'SHOUT_ENTER_PRIV'			=> '%1$s %2$s just enter in the private shoutbox',
	'SHOUT_PURGE_4'				=> '🗑 %1$s Purge of Robot infos done…',
	'SHOUT_PURGE_5'				=> '🗑 %1$s Purge the private shoutbox done…',
	'SHOUT_PURGE_6'				=> '🗑 %1$s Purge the shoutbox done…',
	'SHOUT_PURGE_7'				=> '🗑 %1$s Automatic purge of %2$s messages in the shoutbox done…',
	'SHOUT_PURGE_8'				=> '🗑 %1$s Automatic purge of %2$s messages in the private shoutbox done…',
	'SHOUT_DELETE_AUTO_9'		=> '🗑 %1$s Automatic load shedding of %2$s messages in the shoutbox done…',
	'SHOUT_DELETE_AUTO_10'		=> '🗑 %1$s Automatic load shedding of %2$s messages in the private shoutbox done…',
	...
	'SHOUT_CHARTS_SUBJECT'			=> 'View topic',
