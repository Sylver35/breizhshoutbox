...
// Language for Logs
	...
	'SHOUT_DIV_IMG_EXPLAIN'			=> 'Vous pouvez ajouter une image de fond dans la div (de préférence ayant un certain niveau de transparence).<br />Image à mettre dans “styles/all/theme/images/”<br />Possibilité d’avoir une image différente (portant un nom identique) pour chaque style ajouté.<br />Définissez aussi la position de l’image',
	...
	'SHOUTBOX_VERSION_ACP_COPY'		=> '<a href="%1$s" onclick="window.open(this.href);return false;">Breizh Shoutbox v%2$s</a> © 2018-2020 - Breizhcode - The Breizh Touch',
	'SHOUT_PAGES'					=> 'pages',
