...
// Robot info messages
	'SHOUT_POST_ROBOT_14'		=> '%1$s %2$s vient de publier une annonce générale : %3$s',
	'SHOUT_POST_ROBOT_15'		=> '%1$s %2$s vient de publier une annonce : %3$s',
	'SHOUT_POST_ROBOT_16'		=> '%1$s %2$s vient de publier un nouveau sujet : %3$s',
	'SHOUT_POST_ROBOT_17'		=> '%1$s %2$s vient d’éditer un message : %3$s',
	'SHOUT_POST_ROBOT_18'		=> '%1$s %2$s vient d’éditer un sujet : %3$s',
	'SHOUT_POST_ROBOT_19'		=> '%1$s %2$s vient d’éditer le dernier message du sujet : %3$s',
	'SHOUT_POST_ROBOT_20'		=> '%1$s %2$s vient de répondre à un sujet en citant : %3$s',
	'SHOUT_POST_ROBOT_21'		=> '%1$s %2$s vient de répondre à un sujet : %3$s',
	'SHOUT_PREZ_ROBOT_60'		=> '%1$s %2$s vient de publier sa présentation : %3$s',
	'SHOUT_PREZ_ROBOT_70'		=> '%1$s %2$s vient d’éditer un message dans une présentation : %3$s',
	'SHOUT_PREZ_ROBOT_71'		=> '%1$s %2$s vient d’éditer un message dans sa présentation : %3$s',
	'SHOUT_PREZ_ROBOT_72'		=> '%1$s %2$s vient d’éditer une présentation : %3$s',
	'SHOUT_PREZ_ROBOT_73'		=> '%1$s %2$s vient d’éditer sa présentation : %3$s',
	'SHOUT_PREZ_ROBOT_74'		=> '%1$s %2$s vient d’éditer le dernier message dans une présentation : %3$s',
	'SHOUT_PREZ_ROBOT_75'		=> '%1$s %2$s vient d’éditer le dernier message dans sa présentation : %3$s',
	'SHOUT_PREZ_ROBOT_76'		=> '%1$s %2$s vient de répondre dans une présentation : %3$s',
	'SHOUT_PREZ_ROBOT_77'		=> '%1$s %2$s vient de répondre dans sa présentation : %3$s',
	'SHOUT_PREZ_ROBOT_80'		=> '%1$s %2$s vient de répondre dans une présentation en citant : %3$s',
	'SHOUT_ENTER_PRIV'			=> '%1$s %2$s vient d’entrer dans la shoutbox privée',
	'SHOUT_PURGE_6'				=> '%s Purge de la shoutbox effectuée…',
	'SHOUT_PURGE_5'				=> '%s Purge de la shoutbox privée effectuée…',
	'SHOUT_PURGE_4'				=> '%s Purge des infos Robot effectuée…',
	'SHOUT_PURGE_7'				=> '%s Purge automatique de %s messages de la shoutbox effectuée…',
	'SHOUT_PURGE_8'				=> '%s Purge automatique de %s messages de la shoutbox privée effectuée…',
	'SHOUT_DELETE_AUTO_9'		=> '%s Délestage automatique de %s messages de la shoutbox effectué…',
	'SHOUT_DELETE_AUTO_10'		=> '%s Délestage automatique de %s messages de la shoutbox privée effectué…',
