...
class breizhshoutbox_1_0_0 extends migration
{
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('shout_avatar_img', 'no_avatar.webp')),
			array('config.add', array('shout_avatar_img_robot', 'avatar_robot.webp')),
			...
			array('config.add', array('shout_max_posts_on', 250)),
			array('config.add', array('shout_max_posts', 0)),
			array('config.add', array('shout_max_posts_priv', 0)),
			array('config.add', array('shout_max_posts_on_priv', 250)),
			...
			array('config.add', array('shout_panel_img', 'forward.webp')),
			array('config.add', array('shout_panel_exit_img', 'back.webp')),
