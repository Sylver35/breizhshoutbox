...
class breizhshoutbox_1_0_0 extends migration
{
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('shout_button_background', 1)),
			array('config.add', array('shout_button_background_pop', 1)),
			array('config.add', array('shout_button_background_priv', 1)),
