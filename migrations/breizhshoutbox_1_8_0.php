...
class breizhshoutbox_1_8_0 extends migration
{
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('shout_div_img', '')),
			array('config.add', array('shout_div_img_pop', '')),
			array('config.add', array('shout_div_img_priv', '')),
			array('config.add', array('shout_img_horizontal', '')),
			array('config.add', array('shout_img_horizontal_pop', '')),
			array('config.add', array('shout_img_horizontal_priv', '')),
			array('config.add', array('shout_img_vertical', '')),
			array('config.add', array('shout_img_vertical_pop', '')),
			array('config.add', array('shout_img_vertical_priv', '')),
